...
parser.add_argument('--w_flow', type=float, default=0.01, help='weight of flow loss')
...
parser.add_argument('--test_trials', type=int, help='number of trials for estimating uncertainty', default=20)
parser.add_argument('--fuse_depth_dir', type=str, help='directory of fused depth maps', default='depth_uncertainty_flow')
