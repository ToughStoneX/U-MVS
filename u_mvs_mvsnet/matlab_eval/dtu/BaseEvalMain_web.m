...
%dataPath='/home/xhb/dtu_eval/SampleSet/MVS Data/';
dataPath='/home/admin/workspace/project/datasets/evaluation_dtu/SampleSet/MVS Data/';
%plyPath='/home/xhb/codes/un_mvsnet_pytorch/outputs/';
%resultsPath='/home/xhb/codes/un_mvsnet_pytorch/outputs/';
%plyPath='../../outputs_dense/mvsnet_0.4_0.25/';
%resultsPath='../../outputs_dense/mvsnet_0.4_0.25/';
plyPath='../../outputs/eval/';
resultsPath='../../outputs/eval/';
...
parfor cIdx=1:length(UsedSets)
    ...
    if(~exist(EvalName,'file'))
        ...
        parsave(EvalName, 'BaseEval', BaseEval);
        toc
