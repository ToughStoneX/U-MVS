...
from models.mvsnet_uncertainty import MVSNet
from utils import *
...
parser.add_argument('--dtu_test_root', type=str, default='/home/admin/workspace/project/datasets/mvsnet_dtu/dtu_test/dtu')
...
def save_scene_depth(testlist):
    ...
    with torch.no_grad():
        for batch_idx, sample in enumerate(TestImgLoader):
            ...
            print('Iter {}/{}, Time:{} Res:{}'.format(batch_idx, len(TestImgLoader), end_time - start_time, outputs["depth"].shape))

            # save depth maps and confidence maps
            for filename, depth_est, photometric_confidence in zip(filenames, \
...
if __name__ == '__main__':
    ...
    if args.filter_method != "gipuma":
        ...
        gipuma_filter(testlist, args.outdir, args.prob_threshold, args.disp_threshold, args.num_consistent,
                      args.fusibile_exe_path, args.dtu_test_root)
